...
7. Update relevant AGENTS.md or CLAUDE.md files if you discover reusable patterns (see below)
...
2. **Check for existing AGENTS.md or CLAUDE.md** - Look in those directories or parent directories
