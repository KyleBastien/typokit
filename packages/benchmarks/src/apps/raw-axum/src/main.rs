// Raw Axum baseline benchmark app — hand-written, no TypoKit codegen.
// Mirrors the same 5 endpoints as the TypoKit Axum benchmark but with zero
// generated code to isolate framework overhead from raw runtime performance.
...
async fn main() {
    ...
    eprintln!("Raw Axum benchmark listening on {addr}");
