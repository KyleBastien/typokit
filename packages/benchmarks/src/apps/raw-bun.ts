// Raw Bun baseline benchmark app — zero frameworks.
// Uses only Bun.serve() with hand-written routing, JSON parsing, and validation.
...
/** Start the raw Bun baseline benchmark app */
