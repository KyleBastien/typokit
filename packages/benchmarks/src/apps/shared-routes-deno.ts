// Deno-specific app resource builder using @db/sqlite instead of better-sqlite3.
// Reuses route table, validators, and middleware definitions from the shared
// Node module so all benchmark apps (Node, Bun, and Deno) exercise identical logic.
...
import { buildValidatorMap, handwrittenValidate } from "./shared-routes-common.ts";
...
/** Build handler map and associated resources using @db/sqlite */
export function buildAppResourcesDeno(dbPath?: string): BenchmarkAppResources {
