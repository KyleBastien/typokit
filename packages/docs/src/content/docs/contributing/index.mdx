...
<Aside type="tip">
  If you're not working on the Rust native transform or the Axum plugin, you can skip the Rust toolchain entirely. The prebuilt binaries are used automatically.
</Aside>
