...
1. Create a new TypoKit project using the CLI:
   ...
   This creates four packages in a monorepo layout:

   ```
   notes-api/
   ├── packages/
   │   ├── schema/     # @app/schema — entity types
   │   ├── server/     # @app/server — routes, handlers, middleware
   │   ├── db/         # @app/db — database config + migrations
   │   └── client/     # @app/client — generated API client
   ├── typokit.config.ts
   └── package.json
   ```
...
export type { Note, CreateNoteInput, UpdateNoteInput, NoteSummary } from "./entities/note.js";
```
...
export type { Note, CreateNoteInput, UpdateNoteInput, NoteSummary } from "./entities/note.js";
export type { PaginatedResponse } from "./shared/pagination.js";
```
...
import type { NotesRoutes } from "./contracts.js";
import { db } from "../../db.js";
import { notes } from "../../.typokit/schemas/notes.js";
...
import noteHandlers from "./routes/notes/handlers.js";
