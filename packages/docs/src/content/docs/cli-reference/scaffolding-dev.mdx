...
4. Creates project directory with four packages: `@app/schema`, `@app/server`, `@app/db`, `@app/client`
...
<Aside type="note">
The scaffolded contracts use placeholder types. Replace `User`, `CreateUserInput`, and `UpdateUserInput` with your actual schema-first types from `@app/schema`.
</Aside>
