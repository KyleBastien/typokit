...
<Aside type="tip">
  See the [Building a Rust/Axum Server](/typokit/guides/rust-axum-server/) guide for a step-by-step walkthrough of setting up and using this project structure.
</Aside>
